    ...
    <Document>
      <Page size="A4" orientation="portrait" style={styles.body}>
        ...
        <View style={styles.sectionReglement}>
          <Text style={styles.labelReglement}>Paiement à faire par :</Text>
          <Text style={styles.optionReglement}>
            * Chèque à l’ordre de ENTREPRISE STRATEVENT&CO
          </Text>
          <Text style={styles.optionReglement}>
            * Virement bancaire : compte SIB CI 007 01085 900009850440 - 69 /
            IBAN :CI93 CI0070108590000985044069
          </Text>
        </View>
        <Text style={styles.consigne}>
          Suite au règlement, un justificatif de paiement électronique (par
          virement bancaire) doit être envoyé par email à l’adresse suivante :
          Stratevent.co@gmail.com.
        </Text>
        ...
        <View style={styles.piedPage} fixed>
          ...
          <Text>TEL. 27 22 409 366 / Cel : 05 76 126 645</Text>
